...
plot.new();
legend(x=0,y=.5,title="Spearman Rank Correlation",c("Cross Validation","Retroactive Prediction","95% Confedence Level"),pch=c(4,16,NA),lty=c(5,3,1),col=c(2,4,"gray44"));
for(l in 0:Ls){
  ...
  lines(F$M[F$L==l],F$CORR_RP[F$L==l], type="o",pch=16,lty=3,col=4);
...
par(mfrow=c(3,2),mar=c(2.5,2.5,1.5,1.5));
plot.new();
legend(x=0,y=.5,title="Mean Square Skill Score",c("Cross Validation","Retroactive Prediction"),pch=c(4,16),lty=c(5,3),col=c(2,4));
for(l in 0:Ls){
  plot(x=NULL,,xlim=c(1,12),ylim=c(0,1),type="n",xaxt="s",xlab="Month",ylab="",mgp=c(-1,1,0), yaxs = "i");
  title(paste(l," months ahead"),line=-1);
  axis(side=1,label=TRUE,at=F$M);
  ...
  lines(F$M[F$L==l],F$MSSS_RP[F$L==l], type="o",pch=16,lty=3,col=4);
...
par(mfrow=c(3,2),mar=c(2.5,2.5,1.5,1.5));
plot.new();
legend(x=0,y=.5,title="Spearman Rank Correlation (ENSO Yes)",c("Cross Validation","Retroactive Prediction","95% Confedence Level"),pch=c(4,16,NA),lty=c(5,3,1),col=c(2,4,"gray44"));
for(l in 0:Ls){
  plot(x=NULL,,xlim=c(1,12),ylim=c(0,1),type="n",xaxt="s",xlab="Month",ylab="",mgp=c(-1,1,0), yaxs = "i");
  title(paste(l," months ahead"),line=-1);
  axis(side=1,label=TRUE,at=F$M);
  ...
  lines(F$M[F$L==l],F$CORR_RP_EY[F$L==l], type="o",pch=16,lty=3,col=4);
...
par(mfrow=c(3,2),mar=c(2.5,2.5,1.5,1.5));
plot.new();
legend(x=0,y=.5,title="Mean Square Skill Score (ENSO Yes)",c("Cross Validation","Retroactive Prediction"),pch=c(4,16),lty=c(5,3),col=c(2,4));
for(l in 0:Ls){
  plot(x=NULL,,xlim=c(1,12),ylim=c(0,1),type="n",xaxt="s",xlab="Month",ylab="",mgp=c(-1,1,0), yaxs = "i");
  title(paste(l," months ahead"),line=-1);
  axis(side=1,label=TRUE,at=F$M);
  ...
  lines(F$M[F$L==l],F$MSSS_RP_EY[F$L==l], type="o",pch=16,lty=3,col=4);
